...
export default function ButtonBackToTopPage(props: IButtonBackToTopPageProps) {
    ...
    return (
        <div className={`w-full trasition-all duration-500 ${isVisible ? 'opacity-100' : 'opacity-0'}`}>
            <button onClick={scrollToTop} className='fixed bottom-14  border-[1px]  rounded  w-10 h-10  dark:border-white text-[#f18121] dark:text-white   z-[999] right-4 flex items-center justify-center '>
