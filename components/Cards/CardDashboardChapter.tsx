  ...
  return (
    <div className="w-full lg:max-w-[1200px] m-auto flex flex-col gap-2 text-sm bg-white dark:bg-[#242526] p-5 rounded">
      ...
      <span className="flex flex-wrap text-lg lg:jus gap-2 font-medium justify-center lg:justify-start  ">
        ...
        <p>- Chapter 1</p>
        <p className=" text-[#666666] text-start">
          {`  (Cập nhật lúc: 15:43 16/03/2024)`}
        </p>
      </span>

      <h3 className=" text-[#666666] text-center">
        {` Nếu không xem được truyện vui lòng đổi "SERVER HÌNH" bên dưới`}
      </h3>
      <div className="flex gap-1 justify-center text-white ">
        <button className=" bg-[#5cb85c] p-1 px-2  rounded hover:text-[#f18121] border border-[#4cae4c]">
          <Link href={""}>Server 1</Link>
        </button>
        <button className=" bg-[#428bca] p-1 px-2  rounded hover:text-[#f18121] border border-[#357ebd]">
          <Link href={""}>Server 2</Link>
        </button>
        <button className=" bg-[#428bca] p-1 px-2  rounded hover:text-[#f18121] border border-[#357ebd]">
          <Link href={""}>Server 3</Link>
        </button>
        <button className=" bg-[#428bca] p-1 px-2  rounded hover:text-[#f18121] border border-[#357ebd]">
          <Link href={""}>Server Vip</Link>
        </button>
      </div>
