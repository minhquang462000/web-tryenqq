            ...
            <div className="w-[90%] rounded-md text-center  flex flex-col gap-2 overflow-hidden cursor-pointer relative h-full  m-auto">
              ...
              >
                <div
                  ...
                  className="aspect-[3/4] rounded-md relative overflow-hidden w-full "
                >
                  <Image
                    width={200}
                    height={250}
                  ...
                  <span className="text-white absolute text-[10px] font-medium flex gap-1  top-1 left-2 ">
                    <p className="bg-[#56ccf2] p-1 px-2 w-max rounded-md">
                      {timeFormat(book?.createdAt)}
                    </p>
                    {book?.views > 100 && (
                      <span
                        style={pulseStyle}
                        className="bg-[#ff2853] lg py-1 px-2 rounded-md"
                      >
                        Hot
                      </span>
                    )}
              ...
              >
                <h3
                  onClick={() => handleUpdateView(book?._id)}
                  className="w-full overflow-hidden px-1 hover:text-[#f18121] transition-all duration-300 truncate font-semibold"
                >
